...
def aboutwindow():
    ...
    about.iconbitmap('C:\\Users\\ranay\\OneDrive\\Documents\\GitHub\\sem2_nfsuproject\\ScapyUI\\res\\logo.ico') #File icon logo image path
...
def read_pcap():
    ...
    if file_path:
        ...
        pcap_window.iconbitmap('C:\\Users\\ranay\\OneDrive\\Documents\\GitHub\\sem2_nfsuproject\\ScapyUI\\res\\logo.ico') #File icon logo image path
